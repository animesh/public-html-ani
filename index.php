<?php
#header("Refresh:5");
echo "<link rel=\"icon\" type=\"image/png\" href=\"fuzzylife.png\"/>";
...
$file="checkup/client-".microtime(true);
file_put_contents($file, getenv());
$file="checkup/response-".microtime(true);
